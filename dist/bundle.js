...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_phaser__ = __webpack_require__(/*! phaser */ 49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__loading__ = __webpack_require__(/*! ./loading */ 122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__level1__ = __webpack_require__(/*! ./level1 */ 121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__config__ = __webpack_require__(/*! ./config */ 120);
...
class Game extends __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.Game {
  ...
  constructor () {
    ...
    super(800, 600, __WEBPACK_IMPORTED_MODULE_2_phaser___default.a.CANVAS, 'content', null)

    if(localStorage.getItem("save")){
        __WEBPACK_IMPORTED_MODULE_5__config__["a" /* default */].starsArray = JSON.parse(localStorage.getItem("save"));
        while(__WEBPACK_IMPORTED_MODULE_5__config__["a" /* default */].starsArray[__WEBPACK_IMPORTED_MODULE_5__config__["a" /* default */].level-1]>0){
            __WEBPACK_IMPORTED_MODULE_5__config__["a" /* default */].level++;
        }
    }

    this.state.add("Loading", __WEBPACK_IMPORTED_MODULE_3__loading__["a" /* default */])
    this.state.add("level1", __WEBPACK_IMPORTED_MODULE_4__level1__["a" /* default */])
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__config__ = __webpack_require__(/*! ./config */ 120);
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  create () {
       ...
       this.game.physics.startSystem(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Physics.ARCADE);
        ...
        this.shootsound.mute = !__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].music;
        this.jumpsound = this.add.audio('jump');
        this.jumpsound.mute = !__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].music;
        this.hurtsound = this.add.audio('hurt');
        this.hurtsound.mute = !__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].music;
       ...
       this.start = this.tigerball.animations.add('start', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 0, 2, '', 4), 24, false);
       this.tigerball.animations.add('walk', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 3, 19, '', 4), 24, true);
       this.tigerball.animations.add('stop', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 20, 23, '', 4), 24, false);
       this.tigerball.animations.add('jump', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 24, 37, '', 4), 24, false);
        this.startcrunch =this.tigerball.animations.add('startcrunch', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 38, 39, '', 4), 24, false);
       this.tigerball.animations.add('crunch', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 40, 47, '', 4), 24, true);
       this.tigerball.animations.add('stopcrunch', __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Animation.generateFrameNames( this.JASON_prefix, 49, 50, '', 4), 24, false);
...
update (){
  ...
  render () {
    ...
    placepieces (restart){
        var x = 0;
        for(var i=0;i<__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype.length;i++){
            for (var j=0; j < this.piecequantity[i]; j++){
               ...
               this.game.physics.arcade.enable(this.piece[x]);
                ...
                //custom variable
                this.piece[x].customID =__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[i];
                if(!restart){
    ...
    moveRock (){
        this.stone.alpha = 1;
       this.actionstone =this.game.add.tween(this.stone).to({y:900}, 9000, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Quadratic.InOut, true, 0);
       this.game.add.tween(this.stone.scale).to({x:1, y:1}, 4000, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Quadratic.InOut, true, 0);
        ...
        if(!this.dead){
            ...
            while(!this.Waiting && this.nextInstruction < this.piecesgroup.length){
                ...
                switch(item.customID){
                    case __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[0]:
                        this.walk(item.CustomValue);
                        break;
                    case __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[1]:
                        this.wait(item.CustomValue);
                        break;
                    case __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[2]:
                        this.jump(item.CustomValue);
                        break;
                    case __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[3]:
                        this.crouch(item.CustomValue);
                        break;
                    case __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[4]:
                        this.loop(item.CustomValue);
                        break;
                    case __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].piecetype[5]:
                        this.endloop(i);
                        break;                
                }
                this.nextInstruction++;
    ...
    walk (times){
       ...
       this.action =this.game.add.tween(this.tigerball).to({x:this.tigerball.x + (this.distance*times)}, this.time*times, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Quadratic.InOut, true, 0);
    ...
    levelCompleteF (){
       ...
       __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].starsArray[__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].level-1] = 3;
		// if we completed a level and next level is locked - and exists - then unlock it
		if(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].starsArray[__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].level]==4 &&__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].level<__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].starsArray.length){
			__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].starsArray[__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].level] = 0;	
            __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].level++;
		}
        this.savegame();
    }
    savegame (){
        localStorage.clear();
        localStorage.setItem("save", JSON.stringify(__WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].starsArray));
    }
    menu (){
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  ...
  preload () {
    ...
    this.load.spritesheet("levels", "../assets/levels.png", __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].thumbWidth, __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].thumbHeight);
...
/* all exports used */
/*!*****************************************!*\
  !*** multi babel-polyfill ./js/game.js ***!
  \*****************************************/
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */118);
module.exports = __webpack_require__(/*! C:\Users\MiProfile\Documents\phaser-es6-webpack-master\js\game.js */117);
